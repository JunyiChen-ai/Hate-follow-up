...
from src.eval.evaluate import interval_f1, pooled, within_video_macro

DATASETS = ("HateMM", "HateClipSeg", "MHC", "MHC_zh")  # MHC, MHC_zh: historical only (CLAUDE.md)
