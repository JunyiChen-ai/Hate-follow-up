"""Carrier-vs-context confound: do GT-negative windows that merely MENTION the target get judged positive?"""
import json, re, sys, numpy as np, warnings
warnings.filterwarnings("ignore")
sys.path.insert(0,".")
from src.video_inputs import load_asr, fixed_windows, window_text

FULL="runs/20260910_spvl/full2_dual_evid_stance/predictions.jsonl"
